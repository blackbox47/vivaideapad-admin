...
interface CreatorNotificationListProps {
   ...
   */
  onActivate: (notification: CreatorNotification) => void;
}

export default function CreatorNotificationList({
  notifications,
  onActivate,
}: CreatorNotificationListProps) {
  return (
