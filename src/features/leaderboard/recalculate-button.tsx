  ...
  return (
    <div className="flex flex-col items-end gap-1.5">
      <button
        ...
        onClick={handleClick}
        disabled={isLoading}
        className="inline-flex items-center gap-2 rounded-full border border-[#dfe7e3] bg-white px-5 py-2.5 text-[13px] font-bold text-[#12231f] transition-colors hover:bg-[#f6f8f5] disabled:opacity-60"
      >
        <Icon
