...
export const CREATOR_NOTIFICATIONS_URL = '/creator/notifications';
export const CREATOR_NOTIFICATIONS_READ_ALL_URL =
  '/creator/notifications/read-all';
export const CREATOR_PROFILE_URL = '/creator/profile';
export const CREATOR_PROFILE_PASSWORD_URL = '/creator/profile/password';
export const CREATOR_PROFILE_NOTIFICATIONS_URL =
  '/creator/profile/notifications';
export const CREATOR_PROFILE_AVATAR_URL = '/creator/profile/avatar';
export const CREATOR_PROFILE_PAYOUT_URL = '/creator/profile/payout-method';
